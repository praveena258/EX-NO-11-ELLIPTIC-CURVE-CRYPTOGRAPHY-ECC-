...
int main() {
    ...
    printf("Enter praveena's private key: ");
    scanf("%lld", &privateA);
    ...
    printf("praveena's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    ...
    printf("Shared secret computed by praveena: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
...
## Output:
<img width="1639" height="911" alt="image" src="https://github.com/user-attachments/assets/618cf440-efa0-493b-8ab9-043e5f734f47" />
